"""Sub-package containing the lifelong PIBT MAPF engine.
...
member that may pull in matplotlib (lazily, for visualization). Neither is `viz`, so
importing the solver never costs a plotting dependency.
"""
...
from .solver import plan_pibt_repeated_tasks, set_planning_progress_hook
...
__all__ = [
    ...
    "paths_to_agent_positions",
    # solver
    "plan_pibt_repeated_tasks",
    "set_planning_progress_hook",
]
