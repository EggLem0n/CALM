...
#  USER KNOBS
# ===========================================================================
# The dataset lives in the repo root's data/, two levels up from this package.
...
#     (PowerShell)  $env:TEST_ONLY=1; python scripts/03_forecast/train.py
...
class CustomDataset(Dataset):
    # mean / std / data_name are read back by OpenSTL's BaseDataModule.
